<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeInformation.aspx.cs" Inherits="OnlineShop.Pages.EmployeeInformation.EmployeeInformation" %>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">          
          ...
          <li class="sub-menu">
            <a href="EmployeeInformation.aspx">
              <i class="fa fa-tasks"></i>
              <span>Employee Infoemation</span>
              </a>
          </li>
            <li class="sub-menu">
            <a href="../Employee/AddEmployee.aspx">
              <i class="fa fa-th"></i>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:DropDownList ID="DropDownListDesignation" runat="server" DataSourceID="SqlDataSource2" DataTextField="EmployeeID" DataValueField="EmployeeID" AutoPostBack="True">
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [EmployeeID] FROM [Employee]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    &nbsp;</td>
                <td class="auto-style3">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" CssClass="table table-bordered table-responsive" DataKeyNames="EmployeeID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="598px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ResigningDate" HeaderText="ResigningDate" SortExpression="ResigningDate" />
                        </Columns>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    &nbsp;</td>
                <td class="auto-style3">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Employee] WHERE ([EmployeeID] = @EmployeeID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownListDesignation" Name="EmployeeID" PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
                <td>&nbsp;</td>
